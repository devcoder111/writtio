<template>
  <el-row class="list-backgroung" style="margin-top: 10px; display:flex;">
    <img
      :src="require('@/assets/icon/asset-all posts-gray copy (1).svg')"
      class="iconSvg"
    />
    <div>
